      ...
      <View style={styles.container}>
        <SafeAreaView>
          ...
          >
            ...
            <StatusDisplay message={this.state.loginMessage} messageType={this.state.loginMessageType} />
            ...
            <TouchableOpacity style={[styles.inputGroup, styles.passwordContainer]}>
